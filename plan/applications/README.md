...
|---|---|---:|---|---|
| [001](001-supplies-executable-site.md) | Run the unchanged Supplies tree locally, natively, and on Canopy | P1 | IN PROGRESS — depends on the extracted compiler/tooling milestone | completed SQLite runtimes; Data 002; 003 |
...
| [003](003-development-compiler-and-editor-tooling.md) | Compile and typecheck executable documents consistently in `arbor check`, VS Code, Zed, local Arbor, and Canopy | P1 | PLANNED | Data 002; 001 Supplies corpus |
