...
|---|---|---:|---|---|
| [001](001-supplies-executable-site.md) | Run the unchanged Supplies tree locally, natively, and on Canopy | P1 | IN PROGRESS — compiler and development typechecking are next | completed query, stream, and mutation runtime recorded in [history](../history/outcomes.md) |
