...
| [002](002-reconcile-node-data-model.md) | Make files, documents, directories, collections, tables, and rows one capability-based node model across local, native, Wire, query, mutation, and sync implementations | P1 | IN PROGRESS — file-provider hardening, Wire file rollups/merge, and remaining ontology cleanup remain | accepted data-model/format/locators/stores/wire specification |
