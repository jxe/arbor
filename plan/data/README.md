...
| [002](002-reconcile-node-data-model.md) | Make files, documents, directories, collections, tables, and rows one capability-based node model across local, native, Wire, query, mutation, and sync implementations | P1 | IN PROGRESS — Wire file rollups/merge are live; native offline row projection and remaining private ontology cleanup remain | accepted data-model/format/locators/stores/wire specification |
