...
>
> **Drift check**: `git diff --stat dc34126..HEAD -- packages/authority/src packages/wire/src/updates packages/wire/src/client.ts packages/wire/src/objects.ts spec/wire.md spec/fixtures tests/integration/authority tests/unit/authority tools package.json`
