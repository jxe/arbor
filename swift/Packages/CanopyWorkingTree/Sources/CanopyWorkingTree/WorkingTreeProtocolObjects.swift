...
enum WorkingTreeProtocolValue {
    case unsigned(Int)
    case bytes(Data)
    case text(String)
    case array([WorkingTreeProtocolValue])
    case map([(String, WorkingTreeProtocolValue)])
}

enum WorkingTreeProtocolCodec {
    static func encode(_ value: WorkingTreeProtocolValue) -> Data {
        switch value {
    ...
    static func directory(
        ...
        var fields: [(String, WorkingTreeProtocolValue)] = [
            ("type", .text("directory")),
    ...
    private static func collectionFile(_ value: ProtocolCollectionFileDescriptor) -> WorkingTreeProtocolValue {
        .map([
