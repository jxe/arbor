...
|---|---|---|---|
| Canopy editing and review | implemented, not installed | Inline choice context and block highlight, transformed copies and other compound editor commands, interactive accessibility gates | [Native 008](plans/swift/008-complete-native-move-copy-undo-capture.md), [010](plans/swift/010-inline-choice-context.md) |
