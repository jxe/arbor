...
- **Consolidated request transport prepared.** Paired TS/Swift complete-request codecs combine the target authored model with object/delta transport, verify exact complete-object hashes and transport restrictions, and reject superseded intent fields. Shared transport and semantic vectors cover identity, sparse reconstruction and serialized-prefix preservation. Active queues, Canopy decoding and client submission still use the deployed encoding; coordinated adoption remains in [Plan 011](plans/reliability/011-compatible-accepted-ambiguity.md).
