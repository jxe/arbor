...
- **[plan.md](plan.md)** — the forward roadmap: canonical hosting, whole-tree sharing, workspace composition, scripts, agents, data, fuller publication, and non-blocking polish.
