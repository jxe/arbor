...
- [Declined folder changes for Arbor Sync clients](declined-folder-changes.md): presenting a placed folder with changes the host declined. This is distinct from Canopy's accepted-state review.
