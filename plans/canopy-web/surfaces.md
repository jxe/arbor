...
| Search in the sidebar's toolbar section, `NSPopUpButton` order picker, hover washes | `ArborRootView.swift:1266, 298, 274` | a field above the list, a native `<select>`-style menu |
