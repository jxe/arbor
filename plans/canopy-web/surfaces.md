...
Every picker list (sidebar, Search Contents, Move to, Move Page) takes ↑ ↓ ↩ and Escape; block-menu one-key chips while open: `t * 1 [ > # 2 3 p - m c [ ]`. Publish the table in `docs/canopy/design.md` in the phase that implements each surface.
