...
| One update machine for every working tree | Rebuild the daemon on a TypeScript runner and `FolderSource`, update the iPhone (Joe's go-ahead), then hand off to the web | Clients [001](clients/001-reconcile-client-state-machines.md) |
