...
| One update machine for every working tree | Soak and install the rebuilt daemon and update the iPhone (Joe's go-ahead), then hand off to the web | Clients [001](clients/001-reconcile-client-state-machines.md) |
