...
| Make merge rules replaceable | A sidecar anyone can write against the object store (which also holds the accepted history) and one merge question; plain edits skip it | canopyd [016](canopyd/016-sidecar-on-objects-and-history.md) |
