...
| Make merge rules replaceable | A sidecar anyone can write against two canopyd APIs (objects and history) and one merge question; plain edits skip it | canopyd [016](canopyd/016-sidecar-on-objects-and-history.md) |
