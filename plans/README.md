...
| Extend Native editing and conflict review | Additional move/copy/undo cases, richer review previews and precise inline markers; the core capture, sync and review paths are already implemented | Native [008](swift/008-complete-native-move-copy-undo-capture.md) and [010](swift/010-client-conflict-review.md); server transfer policy in canopyd [014](canopyd/014-source-transfer-proofs.md) |
