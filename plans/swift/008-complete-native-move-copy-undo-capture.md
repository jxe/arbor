...
the admission queue (journals in [the local system](../../docs/architecture/canopy-browser/local-state.md#change-logs), invariants in [client state machines](../../docs/implementing-editors/document-admission.md#7-admission-invariants-and-trace-compaction)), especially
