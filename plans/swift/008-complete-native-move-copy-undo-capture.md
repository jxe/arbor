...
the admission queue (journals in [the local system](../../docs/canopy/local-state.md#source-admission-journals), invariants in [client state machines](../../docs/canopy/document-admission.md#7-admission-invariants-and-trace-compaction)), especially
