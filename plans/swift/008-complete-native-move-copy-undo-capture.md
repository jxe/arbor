...
reconciliation policies remain in [canopyd 014](../canopyd/014-source-transfer-proofs.md).
...
the admission queue (journals in [the local system](../../docs/architecture/canopy-browser/local-state.md#source-admission-journals), invariants in [client state machines](../../docs/implementing-editors/document-admission.md#7-admission-invariants-and-trace-compaction)), especially
...
- canopyd executes and reconciles the operations. Its existing support must cover every emitted
  form before client release. Server policy belongs to [canopyd 014](../canopyd/014-source-transfer-proofs.md);
