...
and the admission invariants in [client state machines](../../docs/canopy/document-admission.md#7-admission-invariants-and-trace-compaction) for implementation
