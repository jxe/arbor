...
- Extend the implemented root-entry alternatives to independent source ranges and nested locations. Range inputs currently retain whole-file choices; implement finer-grained storage and projection without losing exact operations. Preserve the existing snapshot/hidden-alternative and equal-root guarantees.
