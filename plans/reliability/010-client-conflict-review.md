...
- Bind every workspace to accepted update identity and complete alternative keys, not just the projected root. Load bounded conflict detail on demand and retain what is needed to reopen the review offline.
...
- Persist the choice and operation-bearing request before replacing live text. Apply the accepted transition before clearing evidence. Resume unattempted suffixes in order with their original intent and explicit rebase guards.
