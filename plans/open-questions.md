...
9. **Local object store as a hardlink tree.** Answered: [Arbor Sync 001](arborsync/001-file-bytes-are-the-object.md) makes a file's bytes its object so a hardlink is exactly the object, and [Arbor Sync 002](arborsync/002-object-directory.md) builds `objects/<TreeID>/<hex>` and deletes the loopback object route. The measured-cost notes that motivated the question live in 002's "Why this matters".
