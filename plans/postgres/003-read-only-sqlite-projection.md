...
- **State:** PLANNED
- **Depends on:** Postgres 001 backing, the snapshot/observation subset of
  Postgres 002, and Apps 003 activation manifests
- **Unblocks:** offline reads for larger hosted applications; Postgres 004
