...
Cleanup 001 (file-relative links and the PageID cutoff) closed on 2026-09-25; its evidence is in
[status](../status.md#file-relative-markdown-links-and-readable-key-tokens--2026-09-25).
