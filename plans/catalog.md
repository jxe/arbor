...
- [canopyd 014 — Proofs for moved and copied text beyond prose](canopyd/014-source-transfer-proofs.md) — **P3 · PLANNED.** Structural proofs for Markdown list/table/link transfers, same-anchor ordering, and keyed JSON/YAML and code moves.
