...
reconciliation policies remain in [canopyd 014](014-merge-moved-text.md).
...
- canopyd executes and reconciles the operations. Its existing support must cover every emitted
  form before client release. Server policy belongs to [canopyd 014](014-merge-moved-text.md);
