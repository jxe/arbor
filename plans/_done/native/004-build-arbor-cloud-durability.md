...
>   packages/fs packages/arbord native package.json plans/native/README.md
...
- The `iCloud durability` section of `plans/native/README.md` already selects a new,
...
- Corrections to `plans/native/README.md` and `spec/02-directory-format.md` sidecar wording.
...
- [ ] `plans/native/execution.md` marks Plan 004 DONE.
