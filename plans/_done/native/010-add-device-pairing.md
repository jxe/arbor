...
>
> **Drift check**: `git diff --stat dc34126..HEAD -- packages/authority/src packages/wire/src packages/render packages/core spec/04-wire.md spec/05-configuration.md tests`
