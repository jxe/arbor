...
| Share runtime protocol decoding | Kept as a conditional item and admission rule in [Cleanups](../../cleanups/README.md). |
| Remove pre-Canopy readers | Moved to [Cleanups](../../cleanups/README.md) with explicit deployment and retention gates. |

## Data 002 continuations

| Former item | Disposition |
|---|---|
| PageID-shaped compatibility bridge | [Cleanups](../../cleanups/README.md). |
...
| File-provider exact-source cache invalidation | Smaller item in [Speed](../../speed/README.md). |
| Shared SQLite read/observation boundary | Existing [Postgres 002](../../postgres/002-observation-and-semantic-sync.md). |
| Lossless scalar projection | Added to Data 005's invariants and tracked as a cross-provider seam in [Cleanups](../../cleanups/README.md). |
...
| Legacy mutation-journal effect decoder | [Cleanups](../../cleanups/README.md). |
| Canopy application-code isolation | Smaller gated item in [Security](../../security/README.md). |
...
| Web unload draining | Smaller ready item in [Reliability](../../reliability/README.md). |
...
| Deterministic stale async sequences | Smaller ready item in [Testing](../../testing/README.md). |
