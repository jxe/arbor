...
See [the merge tool](../../docs/merge-tool.md) and
...
[008](../canopy-swift/008-complete-native-move-copy-undo-capture.md) owns client capture/submission;
[010](../canopy-swift/010-client-conflict-review.md) owns review. The tool's operation/language
...
- Extend the [prose-transfer rule](../../docs/merge-tool.md#format-support-contract)
