...
import fixtures from "../../../conformance/wire-authored-updates.json";
import { canonicalUpdateIntent, decodeUpdateRequestJSON, encodeUpdateRequestJSON, updateRequestDigest, updateRequestDigests } from "@arbor/wire";
import type { UpdateIntentBase } from "@arbor/wire";
