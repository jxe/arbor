...
- `update-machine.ts`: the working-tree update machine, a pure reducer that
  executes `docs/overstory-spec/conformance/client-state-machines.json` (`working-tree-updates`).
...
[client state machines](../../docs/implementing-editors/document-admission.md).
