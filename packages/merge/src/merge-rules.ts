...
} from "@arbor/stores/wire-collection-file";
import { SchemaSandbox } from "@arbor/stores/schema";
...
export interface SourceMergeInput {
  ...
  proposed: Uint8Array;
  changes?: Array<{ change: string; operations: import("@arbor/wire").SourceOperation[] }>;
