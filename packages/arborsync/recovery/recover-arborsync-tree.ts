...
function usage(): never {
  console.error(`Usage:
  bun packages/arborsync/recovery/recover-arborsync-tree.ts prepare --tree TREE --output DIR [--data-home DIR] [--arborsync URL] [--disk DIR] [--exclude PATH]
  bun packages/arborsync/recovery/recover-arborsync-tree.ts submit --manifest FILE --candidate NAME --expect-current-update UPDATE --expect-current-root ROOT --expect-candidate-root ROOT
