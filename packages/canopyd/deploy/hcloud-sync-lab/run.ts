...
async function acceptance(state: LabState): Promise<void> {
  ...
  const replay = await sshBash(state, "community", [
    ...
    "import { WireClient } from '/opt/arbor-current/packages/protocol/src/index.ts';",
    ...
    "import { readAccountConfigGraphV2, snapshotAccountConfigV2 } from '/opt/arbor-current/packages/canopyd/src/account-policy-v2.ts';",
    ...
    "const graph = readAccountConfigGraphV2(configurationSnapshot, account.account.configuration.id);",
