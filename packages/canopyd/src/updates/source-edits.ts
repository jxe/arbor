import { composeSourceEdits, type PlainSourceEdit, decodeWireDirectory, encodeWireDirectory, hashObject, type ObjectHash } from "@overstory/protocol";
import type { SourceOperation as AuthoredOperation, MaterialRef } from "@overstory/protocol";
 ...
 * refused rather than guessed. `conformance/source-admission-queue.json`
