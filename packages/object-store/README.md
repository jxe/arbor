...
directory graphs from a root. canopyd and the merge sidecar share one store
and stage generated objects separately; see [the merge tool](../../docs/canopyd/merge-tool.md#objects-authority-and-failure).
