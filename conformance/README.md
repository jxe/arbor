...
The vectors are normative only where their owning specification defines an exact representation or result. Reference daemon responses, client presentation values, and replaceable authority algorithms live under [`tests/fixtures`](../tests/fixtures) instead.
